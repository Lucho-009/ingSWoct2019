...
public class Rutas {
    ...
    String Ruta = System.getProperty("user.dir\\Registros2\\");
    
    private void Crear(){
        String archivo = Ruta+".txt";
        File crea_ubicacion = new File(Ruta);
    ...
    public void guardarArchivoBoleto(Rutas objBoleto) {
        try {
            String Pasajero = "boletos.txt";
            File archivo = new File(Pasajero);
            BufferedWriter bw;
            if (archivo.exists()) {
                bw = new BufferedWriter(new FileWriter(archivo, true));
                PrintWriter pw = new PrintWriter(bw);
                pw.print(objBoleto.id_Ruta);
                pw.print("|" + objBoleto.nombre_Ruta);
                pw.print("|" + objBoleto.origen_Ruta);
                pw.print("|" + objBoleto.hora_Ruta);
                pw.print("|" + objBoleto.fecha_Ruta);
                pw.print("|" + objBoleto.destino_Ruta);
                pw.print("|" + objBoleto.costo_Ruta);
                pw.print("\n");
                pw.close();
            } else {
                bw = new BufferedWriter(new FileWriter(archivo, true));
