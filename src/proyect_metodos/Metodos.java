...
public class Metodos {
    ...
    String ubicacion1 = System.getProperty("user.dir\\Registros2\\");
    
    private void Crear(){
        String archivo = ubicacion1+".txt";
        File crea_ubicacion = new File(ubicacion1);
        File crea_archivo = new File(ubicacion1+archivo);
